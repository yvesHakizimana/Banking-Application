...
<%@ page import="com.code.banksystem.bank.models.User" %>
...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="mainMenu.jsp">Your Bank</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="fetch-user-profile">Personal Information</a>
                </li>
                <li class="nav-item">
